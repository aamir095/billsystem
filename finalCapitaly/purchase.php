...
<body>
  ...
  <nav style="padding: 8rem; padding-top: 3rem;">
    <div class="nav nav-tabs" role="tablist">
      <a class="nav-item nav-link nav-color" href="purchase/existingmaterial.php"><i class="i_left fa fa-luggage-cart"></i>Existing Material</a>
      <a class="nav-item nav-link nav-color" href="purchase/existingproduct.php"><i class="i_left fa fa-calendar-alt"></i>Existing Product</a>
    </div>
  </nav>
