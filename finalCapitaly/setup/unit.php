...
<body>
  ...
  <nav style="padding: 8rem; padding-top: 3rem;">
    <div class="nav nav-tabs" role="tablist">
      ...
      <a class="nav-item nav-link nav-color tab_active" href="unit.php"><i class="i_left fa fa-weight-hanging"></i>Unit</a>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content" style="background-color: #004f1e;">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalCenterTitle" style="color: white;">New Unit</h5>
                ...
                <form method="post" action="addunit.php">
                    <div class="modal-body">
                      <div class="form-row" style="margin-top: 0.5rem;">
                        <label for="name" class="col-sm-2" style="color: white;">Unit:</label>
                            <div class="col">
                      ...
                      if ($result->num_rows > 0) {
                        while ($data = mysqli_fetch_array($result)) {?>
                          <tr>
                            ...
                            <td><a style="color: maroon;" href="#editunit<?php echo $data['id'];?>" data-toggle="modal"><i class="fa fa-edit"></i></a>
                              <a style="color: maroon;" onclick="return confirm('Are you sure you want to delete this?')" href="deleteunit.php?del=<?php echo $data['id'];?>"><i class="fa fa-trash"></i></a></td>
          <div class="modal fade" id="editunit<?php echo $data['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content" style="background-color: #004f1e;">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalCenterTitle" style="color: white;">Unit Edit</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: white;">
                  <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <form method="post" action="editunit.php">
                    <div class="modal-body">
                      ...
                      <div class="form-row" style="margin-top: 0.5rem;">
                        <label for="name" class="col-sm-2" style="color: white;">Unit:</label>
                            <div class="col">
                              <input type="text" id="name" name="name" class="form-control form-control-sm" style="width: 75%;" autocomplete="off" required value="<?php echo $data['Unit']; ?>">
                            </div>
                      </div>
                    </div>
                    <div class="modal-footer">
