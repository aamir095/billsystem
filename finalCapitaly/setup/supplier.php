...
<body>
  ...
  <nav style="padding: 8rem; padding-top: 3rem;">
    <div class="nav nav-tabs" role="tablist">
      ...
      <a class="nav-item nav-link nav-color tab_active" href="supplier.php"><i class="i_left fa fa-truck-loading"></i>Supplier</a>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content" style="background-color: #004f1e;">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalCenterTitle" style="color: white;">New Supplier</h5>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-row" style="margin-top: 0.5rem;">
                        <label for="contact" class="col-sm-2" style="color: white;">Contact:</label>
                            <div class="col">
                              <input type="text" id="contact" name="contact" class="form-control form-control-sm" autocomplete="off" required>
                            </div>
                      </div>
                      <div class="form-row" style="margin-top: 0.5rem;">
                      ...
                      <div class="form-row" style="margin-top: 0.5rem;">
                        <label for="website" class="col-sm-2" style="color: white;">website:</label>
                            <div class="col">
                              <input type="text" id="website" name="website" class="form-control form-control-sm" autocomplete="off" required>
                            </div>
                      </div>
                    </div>
                      ...
                      if ($result->num_rows > 0) {
                        while ($data = mysqli_fetch_array($result)) {?>
                          <tr>
                            ...
                            <td><a style="color: maroon;" href="#editsupplier<?php echo $data['id'];?>" data-toggle="modal"><i class="fa fa-edit"></i></a>
                              <a style="color: maroon;" onclick="return confirm('Are you sure you want to delete this?')" href="deletesupplier.php?del=<?php echo $data['id'];?>"><i class="fa fa-trash"></i></a></td>
          <div class="modal fade" id="editsupplier<?php echo $data['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content" style="background-color: #004f1e;">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalCenterTitle" style="color: white;">Supplier Edit</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: white;">
                  <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <form method="post" action="editsupplier.php">
                    <div class="modal-body">
                      ...
                      <div class="form-row">
                            ...
                            <label for="code" class="" style="color: white;">Code:</label>
                            <div class="col">
                              <input type="text" id="code" name="code" class="form-control form-control-sm" autocomplete="off" required value="<?php echo $data['supid']; ?>" readonly>
                            </div>
                      </div>
                      <div class="form-row" style="margin-top: 0.5rem;">
                        <label for="name" class="col-sm-2" style="color: white;">Name:</label>
                            <div class="col">
                              <input type="text" id="name" name="name" class="form-control form-control-sm" autocomplete="off" required value="<?php echo $data['supname']; ?>" readonly>
                            </div>
                      </div>
                      <div class="form-row" style="margin-top: 0.5rem;">
                        <label for="address" class="col-sm-2" style="color: white;">Address:</label>
                            <div class="col">
                              <input type="text" id="address" name="address" class="form-control form-control-sm" autocomplete="off" required value="<?php echo $data['Address']; ?>">
                            </div>
                      </div>
                      <div class="form-row" style="margin-top: 0.5rem;">
                        <label for="contact" class="col-sm-2" style="color: white;">Contact:</label>
                            <div class="col">
                              <input type="text" id="contact" name="contact" class="form-control form-control-sm" autocomplete="off" required value="<?php echo $data['Contact']; ?>">
                            </div>
                      </div>
                      <div class="form-row" style="margin-top: 0.5rem;">
                        <label for="email" class="col-sm-2" style="color: white;">Email:</label>
                      ...
                      <div class="form-row" style="margin-top: 0.5rem;">
                        <label for="website" class="col-sm-2" style="color: white;">website:</label>
                            <div class="col">
                              <input type="text" id="website" name="website" value="<?php echo $data['Website']; ?>" class="form-control form-control-sm" autocomplete="off" required>
                            </div>
                      </div>
                    </div>
                    <div class="modal-footer">
