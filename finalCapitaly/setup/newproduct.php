...
<body>
  ...
  <nav style="padding: 8rem; padding-top: 3rem;">
    <div class="nav nav-tabs" role="tablist">
      ...
      <a class="nav-item nav-link nav-color tab_active" href="newproduct.php"><i class="i_left fa fa-calendar-alt"></i>Product</a>
        ...
        <button type="buttion" class="button" data-toggle="modal" data-target="#addcustomer">
                      ...
                      if ($result->num_rows > 0) {
                        while ($data = mysqli_fetch_array($result)) {?>
                          <tr>
                            ...
                            <td><a style="color: maroon;" href="#editproduct<?php echo $data['id'];?>" data-toggle="modal"><i class="fa fa-edit"></i></a>
          ...
          <div class="modal fade" id="editproduct<?php echo $data['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content" style="background-color: #004f1e;">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalCenterTitle" style="color: white;">Product Edit</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: white;">
                  <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <form method="post" action="editproduct.php">
                    <div class="modal-body">
                      ...
                      <div class="form-row">
                            <label for="date" style="color: white;" class="col-sm-2">Date:</label>
                            <div class="col">
                              <input type="date" id="date" name="date" class="form-control form-control-sm " autocomplete="off" required value="<?php echo $data['date']; ?>" readonly>
                            </div>
                            <label for="code" class="" style="color: white;">Code:</label>
                            <div class="col">
                      ...
                      <div class="form-row" style="margin-top: 0.5rem;">
                        <label for="name" class="col-sm-2" style="color: white;">Name:</label>
                            <div class="col">
                              <input type="text" id="name" name="name" class="form-control form-control-sm" autocomplete="off" required value="<?php echo $data['product']; ?>">
                            </div>
                      </div>
                    </div>
                    <div class="modal-footer">
