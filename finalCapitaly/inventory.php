...
<body>
  ...
  <nav style="padding: 8rem; padding-top: 3rem;">
    <div class="nav nav-tabs" role="tablist">
      <a class="nav-item nav-link nav-color" href="inventory/product.php"><i class="i_left fa fa-calendar-alt"></i>Product</a>
      <a class="nav-item nav-link nav-color" href="inventory/rawmaterial.php"><i class="i_left fa fa-luggage-cart"></i>Raw Material</a>
    </div>
  </nav>
