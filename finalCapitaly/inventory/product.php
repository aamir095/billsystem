...
<body>
  ...
  <nav style="padding: 8rem; padding-top: 3rem;">
    <div class="nav nav-tabs" role="tablist">
      <a class="nav-item nav-link nav-color tab_active" href="product.php"><i class="i_left fa fa-calendar-alt"></i>Product</a>
      <a class="nav-item nav-link nav-color" href="rawmaterial.php"><i class="i_left fa fa-luggage-cart"></i>Raw Material</a>
    </div>
    <div class="tab_card">
      <div class="tab_container">
        <div class="form-row" style="color: white;">
            <div class="form-group col-md-3">
              ...
              <input type="text" id="product"  class="form-control form-control-sm">
            </div>
            <div class="form-group col-md-3">
        ...
        <div class="form-row">
                  <table class="table table-striped table-sm" id="tabledata" style="margin-top: 1rem; color: white;">
                    ...
                    <tbody id="tbodydata">
                      <?php $sql = "SELECT * FROM existingpro";
...
// }
  ...
  //    var input, filter, table, tr, td, i, txtValue;
  //    inputstore = document.getElementById("store");
  //    filter = input.value.toUpperCase();
  //    table = document.getElementById("tabledata");
  //    tr = table.getElementsByTagName("tr");
  //    for (i = 0; i < tr.length; i++) {
