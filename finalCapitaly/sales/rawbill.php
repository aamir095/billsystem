...
<body>
  ...
  <nav style="padding: 8rem; padding-top: 3rem;">
    <div class="nav nav-tabs" role="tablist">
      ...
      <a class="nav-item nav-link nav-color tab_active" href="rawbill.php"><i class="i_left fa fa-chart-line"></i>Raw-Material Bill</a>
        ...
        <div class="form-row" style = "background-color: maroon;padding-top:0.2rem;">
          ...
          <div class="form-row" style="margin-top: 0.5rem;">
            <label for="toname" style="color: white;" class="col-sm-2">To:</label>
              <div class="col">
                  <input type="text" id="toname" name="toname" class="form-control form-control-sm" autocomplete="off" required readonly>
          ...
          <div class="form-row" style="margin-top: 0.5rem;">
            ...
            <label for="orderlpo" style="color: white;" class="col-sm-2">Order/LPO:</label>
              <div class="col">
          ...
          <div class="form-row">
            ...
            <div class="col">
            <select id="select" class="form-control form-control-sm" data-live-search = "true"><option value="0">Select Raw..</option>
            <?php 
                $statement = $connect->prepare("SELECT * FROM existingraw");
                $statement->execute();
                $all_result = $statement->fetchAll();
                $total_rows = $statement->rowCount();
                if($total_rows > 0){
