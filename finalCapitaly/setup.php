...
<body>
  ...
  <nav style="padding: 8rem; padding-top: 3rem;">
    <div class="nav nav-tabs" role="tablist">
      <a class="nav-item nav-link nav-color" href="setup/customer.php"><i class="i_left fa fa-user-plus"></i>Customer</a>
      <a class="nav-item nav-link nav-color" href="setup/supplier.php"><i class="i_left fa fa-truck-loading"></i>Supplier</a>
      <a class="nav-item nav-link nav-color" href="setup/unit.php"><i class="i_left fa fa-weight-hanging"></i>Unit</a>
      <a class="nav-item nav-link nav-color" href="setup/store.php"><i class="i_left fa fa-store"></i>Store</a>
      <a class="nav-item nav-link nav-color" href="setup/newmaterial.php"><i class="i_left fa fa-luggage-cart"></i>Material</a>
      <a class="nav-item nav-link nav-color" href="setup/newproduct.php"><i class="i_left fa fa-calendar-alt"></i>Product</a>
      <a class="nav-item nav-link nav-color" href="setup/ingridient.php"><i class="i_left fa fa-atom"></i>Ingridient</a>
    </div>
  </nav>
