...
<body>
  ...
  <nav style="padding: 8rem; padding-top: 3rem;">
    <div class="nav nav-tabs" role="tablist">
      <a class="nav-item nav-link nav-color tab_active" href="existingmaterial.php"><i class="i_left fa fa-luggage-cart"></i>Existing Material</a>
      <a class="nav-item nav-link nav-color" href="existingproduct.php"><i class="i_left fa fa-calendar-alt"></i>Existing Product</a>
    </div>
    <div class="tab_card">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content" style="background-color: #004f1e;">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalCenterTitle" style="color: white;">Raw-Material</h5>
                ...
                <form method="post" action="rawmaterial.php">
                    <div class="modal-body">
                      <div class="form-row">
                            ...
                            <div class="col">
                              <select id="scode" name="scode" class="form-control form-control-sm" autocomplete="off" required>
                                ...
                                <option value="<?php echo $data['code'].','.$data['rawname'];?>"><?php echo $data['code'];?></option>
                                <?php }}?>
                              </select>
                      ...
                      <div class="form-row" style="margin-top: 0.5rem;">
                            ...
                            <div class="col">
                              <select id="unit" name="unit" class="form-control form-control-sm" autocomplete="off" required>
                      ...
                      <div class="form-row" style="margin-top: 0.5rem;">
                            ...
                            <div class="col">
                              <select id="store" name="store" class="form-control form-control-sm" autocomplete="off" required>
                      ...
                      <div class="form-row" style="margin-top: 0.5rem;">
                        <label for="supplier" class="col-sm-2" style="color: white;">Supplier:</label>
                            <div class="col">
                              <select id="supplier" name="supplier" class="form-control form-control-sm" autocomplete="off" required>
                                <option disabled>store</option>
                                <?php 
                                ...
                                if ($result->num_rows > 0) {
                                   while ($data = mysqli_fetch_array($result)) {?>
                                <option value="<?php echo $data['supname'];?>"><?php echo $data['supname'];?></option>
                                <?php }}?>
                              </select>
                            </div>
                      </div>
                      <div class="form-row" style="margin-top: 0.5rem;">
                        <label for="reference" class="col-sm-2" style="color: white;">Reference:</label>
                            <div class="col">
                              <input type="text" name="reference" id="reference" class="form-control form-control-sm" autocomplete="off" required autocomplete="off">
                            </div>
                      </div>
                    </div>
                    ...
                    <tbody>
                      ...
                      if ($result->num_rows > 0) {
                        while ($data = mysqli_fetch_array($result)) {?>
                          <div>
                            <div>
                         <tr class="clickme" onclick="myFunction()">
                      ...
                      if ($result1->num_rows > 0) {
                        while ($data1 = mysqli_fetch_array($result1)) {?>
                          <tr>
                            ...
                            <table class="table table-sm" style="margin-top: 2rem; color: white;">
