...
<body>
  ...
  <nav style="padding: 8rem; padding-top: 3rem;">
    <div class="nav nav-tabs" role="tablist">
      ...
      <a class="nav-item nav-link nav-color" href="productpurchase.php"><i class="i_left fa fa-calendar-alt"></i>Product Purchase</a>
      <a class="nav-item nav-link nav-color tab_active" href="rawmaterialpurchase.php"><i class="i_left fa fa-luggage-cart"></i>Raw Material Purchase</a>
      ...
      <div class="tab_container">
        <div class="form-row" style="color: white;">
            <div class="form-group col-md-3">
              ...
              <input type="text" id="raw" onkeyup="search()" class="form-control form-control-sm">
            </div>
                  ...
                  <table class="table table-striped table-sm" id ="tabledata" style="margin-top: 1rem; color: white;">
                    ...
                    <tbody id="tbodydata">
                      <?php 
                        ...
                        JOIN existingraw on product_item.pcode = existingraw.code ORDER BY deliverydate DESC";
