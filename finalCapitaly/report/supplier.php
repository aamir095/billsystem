      ...
      <div class="tab_container">
        <div class="form-row" style="color: white;">
            <div class="form-group col-md-3">
              ...
              <input type="text" id="supplier" onkeyup="search()"  class="form-control form-control-sm">
            </div>
        ...
        <div class="form-row">
                  <table class="table table-striped table-sm" id="tabledata" style="margin-top: 1rem; color: white;">
                    ...
                    <tbody id="tbodydata">
                        <?php $sql = "SELECT * FROM supplierbill JOIN supplierpay ON supplierbill.supcode = supplierpay.supcode ";
...
$('.save-button').on('click', function() {
    var val1 = $.trim($('#supplier').val()).replace(/ +/g, ' ').toLowerCase();
