...
<body>
  ...
  <nav style="padding: 8rem; padding-top: 3rem;">
    <div class="nav nav-tabs" role="tablist">
      <a class="nav-item nav-link nav-color" href="report/sales.php"><i class="i_left fa fa-chart-line"></i>Sales</a>
      <a class="nav-item nav-link nav-color" href="report/productpurchase.php"><i class="i_left fa fa-calendar-alt"></i>Product Report</a>
      <a class="nav-item nav-link nav-color" href="report/rawmaterialpurchase.php"><i class="i_left fa fa-luggage-cart"></i>Raw Material Purchase</a>
      <a class="nav-item nav-link nav-color" href="report/supplier.php"><i class="i_left fa fa-truck-loading"></i>Supplier</a>
      <a class="nav-item nav-link nav-color" href="report/customer.php"><i class="i_left fa fa-user"></i>Customer</a>
