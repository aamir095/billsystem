...
<body>
  ...
  <nav style="padding: 8rem; padding-top: 3rem;">
    <div class="nav nav-tabs" role="tablist">
      <a class="nav-item nav-link nav-color" href="sales/salesbill.php"><i class="i_left fa fa-chart-line"></i>Product Bill</a>
      <a class="nav-item nav-link nav-color" href="sales/rawbill.php"><i class="i_left fa fa-chart-line"></i>Raw-Material Bill</a>
      <a class="nav-item nav-link nav-color" href="sales/showbill.php"><i class="i_left fa fa-money-bill"></i>Show Bill</a>
      <a class="nav-item nav-link nav-color" href="sales/deliveryreport.php"><i class="i_left fa fa-file-invoice"></i>Delivery Report</a>
    </div>
  </nav>
